...
img = cv2.imread('dajeroma.jpg')    #reads image
...
cv2.imwrite('laromaaaaaaaaaaa.jpg', img)    #first argument is title (with extension that can be different from imread), second is the image