...
Alcuni psicologi hanno cercato di restituire un modello della cognizione umana, ossia che è possibile riconoscere due tipi di funzionamento del cervello che non corrispondono a due aree cerebrali.

 Sarebbero sostanzialmente due tipi di cognizione, all'interno dei quali rientrano due grandi famiglie di processi:
 * sistema uno che opera in fretta e automaticamente con poco o nessuno sforzo e nessun senso di controllo volontario (associato spesso alla parte emotiva) 
 * sistema due invece indirizzato all'attenzione verso le attività mentali impegnative che richiedono focalizzazione, come i calcoli complessi; le operazioni sistema due sono molto spesso associate alle esperienze soggettive dell'azione, della scelta e della concentrazione. 
 
La tabella che spesso viene riportata è questa, **la percezione è spesso categorizzata come un'operazione cognitiva che rientra all'interno del sistema uno perché è veloce**, parallela e automatica e senza sforzo

Nelle scienze cognitive è il **fast and frugal**, veloce e frugale

**Il sistema due, invece, richiede uno sforzo per essere attivo, non è mai automatico**

Questa categorizzazione è stata molto criticata perché è un po' semplicistica, non c'è alcun dato empirico a sostegno della esistenza di questi due sistemi; da un punto di vista teorico è una astrazione che non ci fa discriminare i due tipi di funzionamento

(leggi Thinking, Fast and Slow)

L'idea è che ci siano alcuni artefatti che  sfruttano M1 e altri M2, quindi questa tipo di razionalità e dei processi cognitivi umani possa essere utilizzata anche per categorizzare gli artefatti

Quello che fa Casati è provare a difendere l'esistenza di altre due modalità a fianco di M1 e M2, che sono analoghe, ma con uso di artefatti, e che chiama M3 e M4

Quindi, per esempio:
* M3 è sistema intuitivo, veloce e approssimativo (simile a M1)
* M4, invece, è una modalità cognitiva, in cui ragioniamo in maniera lenta e con uno sforzo, ma che richiede e che coinvolge un artefatto (simile a M2)

>PER RICAPITOLARE, TASSONOMIE ARTEFATTI e astrazioni:
>	Heersmink, artefatto-centrica (classificare a seconda delle loro proprietà cognitive)
>	
>	Fasoli et al., analizzare gli artefatti cognitive in base alle capacità cognitive (sostitutivi, complementari, innovativi)
>	
>	Casati e Kahnaman, M1 e M2 (M3 e M4)

Problemi comuni di tutte le tassonomie è che la distinzione tramite **percettivo e cognitivo** non sempre è chiara: ci sono oggetti intermedi che magari non sono esattamente cognitivi ma che hanno ruolo cognitivo

Gli artefatti di intelligenza artificiale possono essere considerati artefatti cognitivi? Una caratteristica dei sistemi di intelligenza artificiale che li rende un po' diversi è che sono fortemente multifunzionali; rispetto agli artefatti cognitivi che nella maggior parte dei casi sono monofunzionali. Ci sono diverse caratteristiche che possono essere confrontati rispetto al agli artefatti cognitivi

Quanto ci interroghiamo rispetto agli aspetti teorici, filosofici dell'intelligenza artificiale? Ci vogliamo concentrare soltanto sull'ambito astratto dei compiti cognitivi o anche altri ambiti apparentemente meno nobili, come l'affettività, rientra nell'interno dell'ambito su cui vogliamo confrontarci?

Per questo negli ultimi anni alcuni hanno proposto di introdurre un altro concetto a fianco a quello di artefatto cognitivo che è la nozione di **artefatti affettivi**, ossia degli artefatti che non solo ci danno supporto nei nostri processi cognitivi, ma anche i nostri processi emotivi e affettivi

Davvero la dimensione dell'affettività degli artefatti non sia soltanto accessoria, ma vale la pena riconoscerla? Artefatti affettivi abbastanza vaghi e decisamente per il prof, ma allo stesso tempo è vero che la dimensione affettiva degli artefatti è abbastanza forte

Per spiegare e comprendere i fenomeni affettivi abbiamo bisogno di prendere in considerazione i modi in cui gli agenti ingegnerizzano i loro ambienti affettivi, vale a dire creano **nicchie affettive** e facendo ciò consentono a questi ambienti di influenzare i loro stati effettivi in modo continuativo
L'idea di nicchia è usata molto spesso anche in ambito cognitivo; costruzioni di modificazione dell'ambiente sono svolte per per fini affettivi

*James (psicologia moderna) -Sentiamo già certe cose che sono nostre tanto quanto sentiamo già, ma su noi stessi, la nostra fame, i nostri figli, il lavoro delle nostre mani; possono esserci tanto cari quanto i nostri corpi e suscitare gli stessi sentimenti e le stesse rappresaglie se attaccati.* (non so se è scritta bene)

Una conseguenza della valutazione di questo tipo di concettualizzazione, è la rivalutazione degli oggetti esterni per quanto riguarda i nostri processi mentali

In un'ottica funzionalista di solito siamo portati a pensare alla cognizione, alle emozioni come processi che sono totalmente interni
Il fatto di concettualizzare gli artefatti cognitivi e gli artefatti effettivi permette di riconoscere il ruolo delle delle impalcature degli oggetti per quanto riguarda questi processi, sia importante e come quindi questi richiedano anche un'attenzione particolare

Una parte importante della dell'intelligenza artificiale riguarda la possibilità di arrivare a una robotica sociale 
...
La tesi di cui parleremo è quella che crede che la tecnologia ci renda più distanti rispetto agli altri esseri umani che ci renda più incapaci di comunicare, di gestire gli aspetti emotivi della comunicazione