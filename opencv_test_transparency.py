...
img = cv2.imread('img.jpg', cv2.IMREAD_UNCHANGED)     #second argument will not drop the fourth channel in case of transparency if <0
...
cv2.imwrite("niente.png", t_img)        #this is fully transparent with fill_value=0 and opaque with fill_value=255