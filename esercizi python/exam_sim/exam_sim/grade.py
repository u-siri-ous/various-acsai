...
def do_func3_tests(listA, listB, listC, expected):
    res = program.func3(listA, listB, listC)
...
def test_func3_1():
    ...
    return do_func3_tests(*lists, expected)
