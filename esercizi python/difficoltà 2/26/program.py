...
def es26(table, column):
    ...
    #ordina il dizionario in base alle colonne e le riordina al contrario
    return max(len(x.keys()) for x in table)
     #ritorna il numero di colonne nella tabella, che poi sarebbero le chiavi di ogni dizionario nella lista
